<?php
  ...
  $email = "";
  $phone = "";
  $address = ""; // Assuming you need address
  ...
  if($_SERVER["REQUEST_METHOD"] == 'GET'){
    ...
    $email = $_POST["email"];
    $phone = $_POST["phone"];
    $address = $_POST["address"]; // Assuming you need address

    $sql = "UPDATE crud2 SET name = '$name', email = '$email', phone = '$phone', address = '$address' WHERE id = '$id'";
